...
xpanes.register_pane("pane", {
	...
	groups = {
		...
		--choppy = default.dig.glass,
		--crumbly = default.dig.glass,
		--snappy = default.dig.glass,
...
xpanes.register_pane("pane_obsidian", {
	...
	textures = {"default_obsidian_glass.png","xpanes_pane_half.png^[colorize:black","xpanes_white.png^[colorize:black"},
	inventory_image = "default_obsidian_glass.png",
	wield_image = "default_obsidian_glass.png",
	sounds = default.node_sound_glass_defaults(),
	groups = {cracky = default.dig.glass, pane = 1},
	recipe = {
...
xpanes.register_pane("bar", {
	...
	groups = {cracky = default.dig.iron_door, pane = 1},
