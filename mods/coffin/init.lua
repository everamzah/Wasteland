minetest.register_node("coffin:gravestone", {
	...
	groups = {dig_immediate = 1, cracky = default.dig.stone},
...
minetest.register_node("coffin:coffin", {
	...
	sounds = default.node_sound_wood_defaults({
		dug = {name = "ruins_chest_break", gain = 0.75},
	}),
...
minetest.register_on_dieplayer(function(player)
	...
	minetest.add_node(pos, {name = "coffin:coffin", param2 = param2}) -- FIXME This is it.  ?
	pos.y = pos.y + 1
