...
local def = {
	...
	sounds = {
		on_damage = {name = "creatures_sheep", gain = 0.1, distance = 10}, -- gain=1
		on_death = {name = "creatures_sheep", gain = 0.1, distance = 10}, -- gain=1
		swim = {name = "creatures_splash", gain = 1.0, distance = 10,},
		random = {
			idle = {name = "creatures_sheep", gain = 0.1, distance = 10, time_min = 23}, -- gain=0.6
		},
	},
	...
	modes = {
		...
		eat = {	chance = 0.25,
			duration = 4,
			nodes = {
				"default:grass_1", "default:grass_2", "default:grass_3", --TODO maybe add that grass
				"default:grass_4", "default:grass_5", "default:grass"
			}
		},
	},
