...
dungeon_loot.weapons_list = {
	{name="default:sword_iron", min_depth = 0},
	--{name="default:sword_bronze", min_depth = 50},
	{name="default:sword_iron", min_depth = 50},
	--{name="default:sword_mese", min_depth = 150},
	{name="default:sword_diamond", min_depth = 150},
